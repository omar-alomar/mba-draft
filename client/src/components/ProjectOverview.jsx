...
const ProjectOverview = (props) => {
  ...
  return (
    <div className='flex flex-col w-full'>
      ...
      <div className='m-6'>
        <span className='justify-between align-baseline mr-0 ml-auto'>
          <ArrowBackIcon className='bg-mbaRed text-white cursor-pointer' onClick={handleCommentSubmit} />
        </span>
        <Modal type="none" className='text-gray-500 hover:text-yellow-500' text={<EditIcon />} title='Edit Project' shouldShow={shouldShow}>
        ...
        <Modal type="none" className='text-gray-500 hover:text-red-500' text={<DeleteIcon />} title='Delete Project' shouldShow={shouldShow}>
          <form>
        ...
        <div className='border-solid border-[1px] border-gray-200 drop-shadow'>
          <div className='flex flex-row bg-gray-100 p-1'>
            <h2 className='my-auto text-2xl ml-5'>Project Information</h2>
          </div>
