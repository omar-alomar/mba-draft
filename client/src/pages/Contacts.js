  ...
  return (
    <div className="contacts mx-auto w-full">
      ...
      <div className="m-3 mr-9">
        <Modal type="base" text={<><AddIcon /> new contact</>} title='Create a new contact' shouldShow={shouldShow}>
          <form>
            ...
            <div className='text-right'>
              <Button type="green" text={"Add contact"} clickFunction={handleSubmit} className="mb-5 mr-5" />
            </div>
          </form>
